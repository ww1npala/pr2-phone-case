-- =============================================================
-- SQL-запити для PhoneCase Manager
-- Тема: Розробка модуля керування дизайнами чохлів
-- Автор: Студент групи КН-3
-- =============================================================

-- =============================================================
-- 1. БАЗОВІ SELECT-ЗАПИТИ
-- =============================================================

-- 1.1 Усі активні дизайни з категоріями (JOIN)
SELECT
    d.id,
...
-- 2.1 Всі замовлення з деталями (JOIN чотирьох таблиць)
SELECT
    o.id               AS order_id,
